...
time = pg.time.Clock()
pg.display.set_caption("Utube Lead Game")
...
path = 'C:/Users/Mehmet/Desktop/Çalışma Dosyaları/Bm programları/Yazılımsal/kişisel-python/Game_Tries/pygame_tries/FirstHand/first_tut/'
